...
class Books extends Seeder
{
    ...
    {
        $book = new Book();
        $book->name = 'Súng, Vi Trùng Và Thép (Tái Bản 2020)';
        $book->image = '/image/sung-vi-trung-va-thep.jpg';
        $book->author = 'Jared Diamond';
        $book->category_id = 4;
        $book->price = 204000;
        $book->description = '"Bàn tay của diễn trình lịch sử từ 8.000 năm trước vẫn đang đè nặng lên chúng ta."
