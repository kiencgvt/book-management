            ...
            <div class="table-title">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <a href="{{ route('book.index') }}" class="btn btn-info"><span>Books</span></a>
                    </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                @foreach($categories as $key => $category)
                    <tr>
                        <th>{{ $key + 1 }}</th>
                        <td>{{ $category->name }}</td>
                        <th><a href="{{ route('category.show', $category->id) }}" class="btn btn-info">Show</a></th>
                        <td>
                            <a href="#" class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a onclick="return confirm('Are you sure?')" href="#" class="delete"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
